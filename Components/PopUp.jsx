        ...
        <div className=' relative w-auto my-6 mx-auto max-w-3xl'>
          ...
          bg-white outline-none focus:outline-none'>
            ...
            border-slate-200 rounded-t'>
              ...
              focus:outline-none'
                ...
                <span className='bg-transparent tect-black opacity-5 h-6 w-6 text-2xl 
          ...
          {/*footer*/}  
             ...
             border-t border-solid border-slate-200 rounded-b'>
                ...
                <button
                  className="background text-white active:bg-emerald-600 font-bold uppercase tet-sm 
                             px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none 
                             mr-1 mb-1 ease-linear transition duration-150"
                  type='button'
